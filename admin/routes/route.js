...
route.post("/forgotpass",passport.checkAuth,ctl.forgotPass);
route.post("/checkpass",passport.checkAuth,ctl.checkPass);
route.post("/checkpassword",passport.checkAuth,ctl.checkPassword);
